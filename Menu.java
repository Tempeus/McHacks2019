...
//	Constructor for Menu
	private static JFrame f = new JFrame("The Thrower");
...
//	Simulation stuff
	private static double initialxPos = 1 * SCALE;
	private static double initialheight = 1 * SCALE;
...
//		Panel for the title
		...
		/*
		 * // Panel for the distance JPanel distancePanel = new JPanel(); // Label to
		 * indicate what the box is for JLabel distanceLabel = new JLabel("Distance");
		 * distancePanel.add(distanceLabel); distanceText.setPreferredSize(new
		 * Dimension(50,25)); distancePanel.add(distanceText);
		 */
//		Label for scale
